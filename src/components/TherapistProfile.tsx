    ...
    return (
        <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="mt-5 md:basis-1/4 rounded-3xl">
                <Card isBlurred={true}
                      className=" bg-zinc-100 text-stone-900 h-fit p-0">
                    <div className="w-full h-[24%] bg-primary absolute rounded-b-[30%]">
                        <div className="w-12 h-12 bg-black/30 hover:bg-black/40 hover:cursor-pointer z-20 rounded-full flex items-center justify-center absolute right-2 top-2">
                            <Link href={`/edit`}><Pencil/></Link>
                        </div>
                    </div>
                    <CardHeader className="flex flex-col justify-center">
                        <div
                            className="bg-zinc-200 w-52 h-52 rounded-3xl overflow-hidden flex items-center justify-center">
                        ...
                        <div className="mt-1">
                            {!therapist?.verified &&
                                <div className="flex items-center justify-center gap-1">
                                    ...
                                    <h3 className="text-sm text-center text-red-900">Waiting for Verification</h3>
                                </div>
                            }
                            {therapist?.verified &&
                                <div className="flex items-center justify-center gap-1">
                            ...
                            <div className="">
                                ...
                                <div className="flex w-full justify-between mt-4 gap-1">
                                    ...
                                    <div className="flex basis-3/5 ">
                                        <p className="text-sm"><span
                                            className="text-black ">Specialization</span> : {therapist?.specialization}
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex basis-2/5  justify-end">
                                        <p className="text-sm"><span
                                            className="text-black ">Experience</span> : {therapist?.experience} years
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex w-full justify-between mt-4 gap-1">
                                    ...
                                    <div className="flex basis-2/6 ">
                                        <p className="text-sm flex items-center gap-1"><span
                                            className="text-black "><Clock3
                                            className="w-4 h-4"/></span> {therapist.meetDuration} mins.
                                        </p>
                                    </div>
                                    ...
                                    <div className="flex basis-2/6 justify-center">
                                        <p className="text-sm flex items-center gap-1"><span
                                            className="text-black ">₹</span> {therapist.sessionCost}
                                        </p>
                                    </div>

                                    <div className="flex basis-2/6 justify-end">
                                        <p className="text-sm flex items-center gap-1"><span
                                            className="text-black ">Mode</span> : {therapist.sessionMode}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col items-center justify-center mt-6">
                                    ...
                                    <h3 className="text-sm text-center">Raindrops race down the window, a symphony on
                                        glass. A steaming mug warms my hands, the books pages whisper secrets. A ginger
                                        cat purrs, a furry orange weight on my lap. Outside, wind howls, but here,
                                        warmth and comfort. (298 characters) </h3>
                                </div>
